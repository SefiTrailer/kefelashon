                            ...
                            <div className="flex flex-col items-center w-full flex-1">
                                <div className="flex flex-col items-center justify-around w-full flex-1 text-right dir-rtl">
                                    <div className="flex justify-center w-full shrink-0">
                                        <img src="./logo.webp" alt="כפלשון" className="object-contain drop-shadow-[0_0_32px_rgba(236,72,153,0.7)] transition-transform hover:scale-105" style={{ height: `${sidebarH * 0.23}px`, maxHeight: '160px' }} onError={(e) => { e.target.onerror = null; e.target.src = './logo.png'; }} />
                                    </div>
